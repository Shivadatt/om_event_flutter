              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        ...
                        DropdownButton<String>(
                          ...
                          onChanged: (val) {
                            if (val != null) controller.updateQuotation(quote.id, val);
                          },
                    ...
                    Text(quote.customerName, style: AppTheme.serifHeader(fontSize: 18, fontWeight: FontWeight.bold)),
                    const SizedBox(height: 4),
                    Text("Phone: ${quote.customerPhone}", style: AppTheme.sansBody(fontSize: 13)),
                    Text("Location: ${quote.location}", style: AppTheme.sansBody(fontSize: 13)),
                    Text("Event Date: ${AppFormatters.formatShortDate(quote.eventDate)} at ${quote.eventTime}", style: AppTheme.sansBody(fontSize: 13)),
                    ...
                    Row(
                      ...
                      children: [
                        Text(
                          ...
                          style: AppTheme.sansBody(fontSize: 15, fontWeight: FontWeight.bold),
                        ),
