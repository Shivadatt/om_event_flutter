...
/// Centralized icon constants to standardize icon usage across widgets.
class AppIcons {
  AppIcons._();
  ...
  static const IconData item = Icons.style_outlined;
  ...
  static const IconData role = Icons.manage_accounts_outlined;
}
